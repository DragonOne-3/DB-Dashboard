...
ID_COLUMNS = ["bidNtceNo", "bidPblancNo", "공고번호", "입찰공고번호", "bidNo", "id"]
DATE_COLUMNS = ["anmtDate", "공고일자", "공고일", "bidNtceDate"]
TITLE_COLUMNS = ["bidPblancNm", "공고명", "bidNtceNm", "입찰공고명", "사업명"]
AGENCY_COLUMNS = ["ornt", "발주기관", "dminsttNm", "수요기관"]
AMOUNT_COLUMNS = ["asignBdgtAmt", "배정예산", "presmptPrce", "추정가격", "기초예가"]
...
def main() -> None:
    ...
    fresh = parallel_collect(date_chunks(start, end, 14), fetch_chunk, "입찰공고")
