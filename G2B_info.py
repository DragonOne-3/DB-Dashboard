...
FULL_DISTRICT_LIST = [
    ...
    "광주광역시 동구", "광주광역시 서구", "광주광역시 남구", "광주광역시 북구", "광주광역시 광산구","광주광역시",
    ...
    "제주특별자치도 제주시", "제주특별자치도 서귀포시","제주특별자치도"
]
...
try:
    ...
    if not df.empty:
        # [수정] 1. 기관명 필터링 (FULL_DISTRICT_LIST로 시작하는 데이터 모두 포함)
        ...
        with col2:
            st.download_button(
                label=f"📥 {selected_region} 데이터 다운로드",
                data=csv_data,
