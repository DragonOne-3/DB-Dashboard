...
st.markdown("""
    ...
    /* 퀵버튼 및 입력창 높이 정렬 (상단 맞춤) */
    div[data-testid="stVerticalBlock"] > div[style*="flex-direction: column;"] { justify-content: flex-start !important; }
    ...
    with tab:
        ...
        with center_area:
            ...
            with r2_r:
                ...
                # 입력창과 버튼의 상단 라인을 맞추기 위해 columns 배치 내에서 직접 관리
